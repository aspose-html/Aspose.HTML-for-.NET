...
namespace Aspose.HTML.Live.Demos.UI.Config
{
	/// <summary>
	/// Wrapper class for Aspose.HTML Tools context access to Pages and controls
	/// </summary>
	public class AsposeHTMLContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeHTMLContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeHTMLContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeHTMLContext atcc { set { atc = value; } }
		internal static AsposeHTMLContext Current
		{
			get { return atc; }
		}
