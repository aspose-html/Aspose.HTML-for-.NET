...
namespace Aspose.HTML.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _asposeHTMLLiveDemosPath = ConfigurationManager.AppSettings["AsposeHTMLLiveDemosPath"].ToString();
		...
		private static string _asposeHTMLAppsAssetURL = ConfigurationManager.AppSettings["AsposeHTMLAppsAssetURL"];
		...
		public static string AsposeHTMLAppsAssetURL
		{
			get { return _asposeHTMLAppsAssetURL; }
		}	
        ...
        public static string AsposeHTMLLiveDemosPath
        {
            get { return _asposeHTMLLiveDemosPath; }
        }
